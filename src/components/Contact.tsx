            ...
            <AnimatePresence mode="wait">
              {!submitSuccess ? (
                ...
                >
                  ...
                  {/* Submit Error */}
                  {submitError && (
                    <div className="p-4 rounded-xl bg-rose-50 border border-rose-200 text-rose-800 text-sm font-medium leading-relaxed flex items-center gap-3" id="contact-submit-error">
